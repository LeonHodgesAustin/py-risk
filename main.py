...
from table import sequential as table
...
def fort_ammo_shortage_well_armed_case(args, return_queue=None):
    a_troops = args[0]
    b_troops = args[1]
    a = Territory("A", "Leon", a_troops,
                  attack_modifications=[mods.well_armed])
...
def fort_ammo_shortage_case(args, return_queue=None):
    a_troops = args[0]
    b_troops = args[1]
    a = Territory("A", "Leon", a_troops)
    b = Territory("B", "Leon", b_troops,
...
def bunker_ammo_shortage_well_armed_case(args, return_queue=None):
    a_troops = args[0]
    b_troops = args[1]
    a = Territory("A", "Leon", a_troops,
                  attack_modifications=[mods.well_armed])
...
def rivalry_case(args, return_queue=None):
    a_troops = args[0]
    b_troops = args[1]
    a = Territory("A", "Leon", a_troops,
                  attack_modifications=[mods.rivalry])
    b = Territory("B", "Leon", b_troops)
    while(a.attack_max() > 0 and b.defend_max() > 0):
        game.attack(a, a.attack_max(), b, b.defend_max())
    if return_queue is None:
...
def fort_bunker_rivalry_case(args, return_queue=None):
    a_troops = args[0]
    b_troops = args[1]
    a = Territory("A", "Leon", a_troops,
                  attack_modifications=[mods.rivalry])
...
def fort_ammo_shortage_rivalry_case(args, return_queue=None):
    a_troops = args[0]
    b_troops = args[1]
    a = Territory("A", "Leon", a_troops,
                  attack_modifications=[mods.rivalry])
...
def bunker_ammo_shortage_rivalry_case(args, return_queue=None):
    a_troops = args[0]
    b_troops = args[1]
    a = Territory("A", "Leon", a_troops,
                  attack_modifications=[mods.rivalry])
...
def fort_rivalry_case(args, return_queue=None):
    a_troops = args[0]
    b_troops = args[1]
    a = Territory("A", "Leon", a_troops,
                  attack_modifications=[mods.rivalry])
...
def bunker_rivalry_case(args, return_queue=None):
    a_troops = args[0]
    b_troops = args[1]
    a = Territory("A", "Leon", a_troops,
                  attack_modifications=[mods.rivalry])
...
def main(args=None):
    ...
    # write_csv(gen_table(30, fort_bunker_case), "charts/fort_bunker_case.csv")
    ...
    write_csv(gen_table(30, fort_bunker_well_armed_case),
              "charts/fort_bunker_well_armed_case.csv")
    print "Starting fort_well_armed_case"
    write_csv(gen_table(30, fort_well_armed_case),
              "charts/fort_well_armed_case.csv")
    print "Starting bunker_well_armed_case"
    write_csv(gen_table(30, bunker_well_armed_case),
              "charts/bunker_well_armed_case.csv")
    print "Starting well_armed_case"
    write_csv(gen_table(30, well_armed_case),
              "charts/well_armed_case.csv")
    # print "Starting fort_ammo_shortage_well_armed_case"
    # write_csv(gen_table(30, fort_ammo_shortage_well_armed_case),
    #           "fort_ammo_shortage_well_armed_case.csv")
    # print "Starting bunker_ammo_shortage_well_armed_case"
    # write_csv(gen_table(30, bunker_ammo_shortage_well_armed_case),
    #           "bunker_ammo_shortage_well_armed_case.csv")
    # print "Starting rivalry_case"
    # write_csv(gen_table(30, rivalry_case),
    #           "rivalry_case.csv")
    # print "Starting rivalry_ammo_shortage_case"
    # write_csv(gen_table(30, rivalry_ammo_shortage_case),
    #           "rivalry_ammo_shortage_case.csv")
    # print "Starting fort_bunker_rivalry_case"
    # write_csv(gen_table(30, fort_bunker_rivalry_case),
    #           "fort_bunker_rivalry_case.csv")
    # print "Starting fort_rivalry_case"
    # write_csv(gen_table(30, fort_rivalry_case),
    #           "fort_rivalry_case.csv")
    # print "Starting bunker_rivalry_case"
    # write_csv(gen_table(30, bunker_rivalry_case),
    #           "bunker_rivalry_case.csv")
    # print "Starting fort_ammo_shortage_rivalry_case"
    # write_csv(gen_table(30, fort_ammo_shortage_rivalry_case),
    #           "fort_ammo_shortage_rivalry_case.csv")
    # print "Starting bunker_ammo_shortage_rivalry_case"
    # write_csv(gen_table(30, bunker_ammo_shortage_rivalry_case),
    #           "bunker_ammo_shortage_rivalry_case.csv")
    print "Starting fort_ammo_shortage_case"
    gen_table(30, fort_ammo_shortage_case)
    end = timer()
